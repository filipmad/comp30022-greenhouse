  ...
  return (
    <div className="environmental-container">
      ...
      <div className="environmental-pillar-container">
        <Link to="/discover/environmental/goal6" className="environmental-pillar-item">
        ...
        <Link to="/discover/environmental/goal7" className="environmental-pillar-item">
          <h2>Goal 7: Affordable and Clean Energy</h2>
          <p>Ensure access to affordable, reliable, sustainable, and modern energy for all.</p>
        </Link>

        <Link to="/discover/environmental/goal13" className="environmental-pillar-item">
          <h2>Goal 13: Climate Action</h2>
          <p>Take urgent action to combat climate change and its impacts.</p>
        </Link>

        <Link to="/discover/environmental/goal14" className="environmental-pillar-item">
        ...
        <Link to="/discover/environmental/goal15" className="environmental-pillar-item">
