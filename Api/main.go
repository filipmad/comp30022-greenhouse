...
func main() {
	...
	r.HandleFunc("/get-ecoadventure-score", getEcoAdventureScore(db, "gameOneHighScore"))
	r.HandleFunc("/get-cityscape-score", getCityScapeData(db))
	
	r.HandleFunc("/update-ecoadventure-score", updateEcoAdventureScore(db, "gameOneHighScore")).Methods("POST")
	r.HandleFunc("/update-cityscape-score", updateEcoAdventureScore(db, "gameTwoHighScore")).Methods("POST")
